...
namespace RedMist.TimingAndScoringService.EventStatus.PenaltyEnricher;
...
public class ControlLogEnricher : BackgroundService
{
    ...
    private volatile ImmutableDictionary<string, CarPenality> penaltyLookup;
        ...
        IConfiguration configuration, SessionContext sessionContext)
    {
        ...
        penaltyLookup = ImmutableDictionary<string, CarPenality>.Empty; 
    }
    ...
    protected override async Task ExecuteAsync(CancellationToken stoppingToken)
    {
        while (!stoppingToken.IsCancellationRequested)
        {
            try
            {
                ...
                var penalties = new Dictionary<string, CarPenality>();
