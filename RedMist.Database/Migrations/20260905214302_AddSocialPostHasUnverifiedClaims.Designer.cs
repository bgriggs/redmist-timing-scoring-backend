...
namespace RedMist.Database.Migrations
{
    ...
    [Migration("20260905214302_AddSocialPostHasUnverifiedClaims")]
    partial class AddSocialPostHasUnverifiedClaims
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RedMist.Database.Models.CarLapLog", b =>
                {
                    ...
                    b.HasIndex("EventId", "SessionId", "CarNumber", "LapNumber");
            ...
            modelBuilder.Entity("RedMist.Database.Models.EventSponsorStatistics", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<long>("EngagementDurationMs")
                        .HasColumnType("bigint");
                    ...
                    b.Property<long>("SponsorStatisticsId")
                        .HasColumnType("bigint");

                    b.Property<int>("ViewableImpressions")
                        .HasColumnType("integer");

                    b.HasKey("Id");

                    b.HasIndex("SponsorStatisticsId");

                    b.ToTable("EventSponsorStatistics");
                });
            ...
            modelBuilder.Entity("RedMist.Database.Models.EventStatusLog", b =>
                {
                    ...
                    b.HasIndex("EventId", "Timestamp", "Id");

                    NpgsqlIndexBuilderExtensions.IncludeProperties(b.HasIndex("EventId", "Timestamp", "Id"), new[] { "SessionId" });
            ...
            modelBuilder.Entity("RedMist.Database.Models.SourceSponsorStatistics", b =>
                {
                    ...
                    b.ToTable("SourceSponsorStatistics");
                });

            modelBuilder.Entity("RedMist.Database.Models.Sponsor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("RedMist.Database.Models.SponsorExclusion", b =>
                {
                    b.Property<int>("OrganizationId")
                        .HasColumnType("integer");
                    ...
                    b.HasKey("OrganizationId", "SponsorId");

                    b.ToTable("SponsorExclusions");
                });
            ...
            modelBuilder.Entity("RedMist.Database.Models.SponsorStatistics", b =>
                {
                    ...
                    b.ToTable("SponsorStatistics");
                });

            modelBuilder.Entity("RedMist.Database.Models.SponsorTelemetryLog", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("RedMist.TimingCommon.Models.Configuration.Event", b =>
                {
                    ...
                    b.Property<string>("ExternalConfig")
                        .HasColumnType("text");
